...
const createTableMessages = "CREATE TABLE IF NOT EXISTS messages (userId VARCHER(255), messages VARCHAR(255), answer VARCHAR(255), likes VARCHAR(255), PRIMARY KEY (userID))";
